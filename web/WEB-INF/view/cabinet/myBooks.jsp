...
<script>
    var returned = '<fmt:message bundle="${i18n}" key="book.returned"></fmt:message>';
</script>
<div class="container">
        ...
        <c:forEach var="formVO" items="${formVOS}">
            <div class="card">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">
                        <b><fmt:message bundle="${i18n}" key="book.receival.type"></fmt:message>: </b>
                            ${formVO.form.receivalType}
                    </li>
                    <li class="list-group-item">
                        <b><fmt:message bundle="${i18n}" key="book.receival.date"></fmt:message>: </b>
                            ${formVO.form.receivalDate}
                    </li>
                    <li class="list-group-item">
                        <b><fmt:message bundle="${i18n}" key="book.return.date"></fmt:message>: </b>
                            ${formVO.form.returnDate}
                    </li>
                </ul>
                <div class="card-body">
                    <button class="btn btn-primary return-book" id="${formVO.bookVO.book.bookID}">
                        <fmt:message bundle="${i18n}" key="book.return"></fmt:message>
                    </button>
                </div>
            </div>
